					...
					<div class="navbar-collapse collapse">							
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation"><a href="spn_scholars.php" class="active" >My Scholars</a></li>
        ...
        <div class="blog">
            <div class="row">
                 <div class="col-md-10 col-md-offset-1">
                 	<h1 class="text-center" style="color: #000;margin-top: 0px">MY SCHOLARS</h1>
				  <div class="blog-item" style="min-height: 500px;border-top: 1px solid #ccc;padding-top: 30px;">
                         ...
                         <table class="table table-bordered" id="myTable">
							...
							<tbody>
								<?php
									require 'spn_scholar_retrieve_script.php';
								?>
							</tbody>
						 </table> 
                    </div><!--/.blog-item-->
